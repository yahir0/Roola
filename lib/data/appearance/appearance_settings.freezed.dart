...
/// 既定値はウィンドウ枠が視認できる程度の 0.8。
 double get transparencyOpacity;/// Polaris のアクセント色（ADR-0038 D4）。既定はゴールド。
 PolarisAccent get accent;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppearanceSettings&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.transparencyOpacity, transparencyOpacity) || other.transparencyOpacity == transparencyOpacity)&&(identical(other.accent, accent) || other.accent == accent));
}


@override
int get hashCode => Object.hash(runtimeType,mode,transparencyOpacity,accent);

@override
String toString() {
  return 'AppearanceSettings(mode: $mode, transparencyOpacity: $transparencyOpacity, accent: $accent)';
}
...
@useResult
$Res call({
 AppearanceMode mode, double transparencyOpacity, PolarisAccent accent
});
...
/// Create a copy of AppearanceSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mode = null,Object? transparencyOpacity = null,Object? accent = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AppearanceMode mode,  double transparencyOpacity,  PolarisAccent accent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppearanceSettings() when $default != null:
return $default(_that.mode,_that.transparencyOpacity,_that.accent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AppearanceMode mode,  double transparencyOpacity,  PolarisAccent accent)  $default,) {final _that = this;
switch (_that) {
case _AppearanceSettings():
return $default(_that.mode,_that.transparencyOpacity,_that.accent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AppearanceMode mode,  double transparencyOpacity,  PolarisAccent accent)?  $default,) {final _that = this;
switch (_that) {
case _AppearanceSettings() when $default != null:
return $default(_that.mode,_that.transparencyOpacity,_that.accent);case _:
  return null;
...
class _AppearanceSettings implements AppearanceSettings {
  const _AppearanceSettings({this.mode = AppearanceMode.opaque, this.transparencyOpacity = 0.8, this.accent = PolarisAccent.gold});
...
@override@JsonKey() final  PolarisAccent accent;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppearanceSettings&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.transparencyOpacity, transparencyOpacity) || other.transparencyOpacity == transparencyOpacity)&&(identical(other.accent, accent) || other.accent == accent));
}
...
/// Create a copy of AppearanceSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mode = null,Object? transparencyOpacity = null,Object? accent = null,}) {
